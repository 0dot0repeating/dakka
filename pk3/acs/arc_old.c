...
#include "arc_old/arc_const.h"
#include "arc_old/arc_user_const.h"
#include "arc_old/arc_target.h"
#include "arc_old/arc_look.h"
#include "arc_old/arc_angle.h"
#include "arc_old/arc_main.h"
#include "arc_old/arc_user.h"


script "Arc_Open" open
{
    SetDBEntry("dakka_arc", "client_iszand", 789237);
    IsZandronum = GetDBEntry("pickup", "client_iszand") == 789237;
}