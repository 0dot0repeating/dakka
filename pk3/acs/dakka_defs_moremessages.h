...
int MMSG_ExtraMessages[MMSG_SLOTS][MMSG_COUNT] = 
{
    ...
    { // Minigun
        ...
        "A picture's worth a thousand words, but what's worth a thousand bullets?",
        ...
        "Its hunger for ammo is only matched by your hunger for dead demons.",
        "For when you need to have your toast \caright now.\c-",
